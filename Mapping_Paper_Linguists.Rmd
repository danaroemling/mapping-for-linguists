...
author: "Dana Roemling, Bodo Winter, Jack Grieve"
date: '2023-10-10'
output:
 html_document:
   toc: true
...
# version 1.0.1
library(rnaturalearthhires) # same as rnaturalearth but higher resolution (optional)
# version 1.0.0.9000
...
```{r gsa_data}
gsa_data <- read_csv("https://raw.githubusercontent.com/danaroemling/mapping-for-linguists/main/MAPPING_DIALECT.csv")
...
```{r us_data}
us_data <- read_csv("https://raw.githubusercontent.com/danaroemling/mapping-for-linguists/main/MAPPING_PRONOUNS.csv")
