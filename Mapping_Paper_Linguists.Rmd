...
word_order$new_long <- ifelse(word_order$longitude < 0, 
                             word_order$longitude + 360, 
                             word_order$longitude)
```

Now we can re-run our code based on the new data.

```{r pacific world map 2}
...
us_geo_data$f_quantile <- recode(us_geo_data$f_quantile, 
                                 "[0,889.7]"="< 890", 
                                 "(889.7,1243]"="< 1243", 
                                 "(1243,1557]" = "< 1557", 
                                 "(1557,1935]" = "< 1935", 
